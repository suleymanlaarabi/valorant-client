        ...
        <>
            ...
            <div className='Modal'>
                ...
                <div className='paragrapheRef animate'>
                    <h3>Ratio de tire : <span>{props.armeInfo.armeState.fireRate}</span></h3>
                    <h3>Temps de recharge : <span>{props.armeInfo.armeState.reloadTimeSeconds}s</span></h3>
                    <h3>Temps d'equipage : <span>{props.armeInfo.armeState.equipTimeSeconds}</span></h3>
